...
class AddressTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create address_type" do
    assert_difference("AddressType.count") do
      post address_types_url, params: { address_type: { address_type: @address_type.address_type } }
    end
  ...
  test "should update address_type" do
    patch address_type_url(@address_type), params: { address_type: { address_type: @address_type.address_type } }
